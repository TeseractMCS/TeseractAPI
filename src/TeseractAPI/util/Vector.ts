...
import { Vector2Utils, Vector3Utils } from './CoreHelper';
 ...
 *
 * For an immutable version of the build, use ImmutableMinecraftVector3Builder.
 *
 * @public
 */
export class Vector3 implements MinecraftVector3 {
    x: number;
    y: number;
    z: number;
     ...
     */
    assign(vec: MinecraftVector3): this {
        this.x = vec.x;
        this.y = vec.y;
        this.z = vec.z;
        return this;
     ...
     */
    equals(v: MinecraftVector3): boolean {
     ...
     */
    subtract(v: MinecraftVector3): this {
     ...
     */
    dot(vec: MinecraftVector3): number {
     ...
     */
    cross(vec: MinecraftVector3): this {
     ...
     */
    distance(vec: MinecraftVector3): number {
     ...
     */
    clamp(limits: { min?: Partial<MinecraftVector3>; max?: Partial<MinecraftVector3> }): this {
     ...
     */
    lerp(vec: MinecraftVector3, t: number): this {
     ...
     */
    slerp(vec: MinecraftVector3, t: number): this {
